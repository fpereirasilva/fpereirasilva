...
## 🖥️ Tela Preta — Founder & Instructor

I am the founder and instructor of **[Tela Preta](https://www.telapreta.dev.br)**, a technical training platform focused on practical, hands-on courses in **Linux**, **Docker**, **Kubernetes**, **Azure**, **DevOps**, and **Artificial Intelligence**.

The Tela Preta initiative was born from a passion for sharing real-world knowledge, making complex technologies accessible to everyone — from beginners to experienced professionals. Courses are designed with a "black screen" (terminal) first approach, emphasizing command-line proficiency, real-world labs, and market-ready skills.

🌐 [telapreta.dev.br](https://www.telapreta.dev.br)
...
- Generative AI and Machine Learning — AWS Bedrock and Generative AI services
- Cloud Native Architecture and Containers (Docker and Kubernetes)
- DevOps Architecture and platform automation
- Cloud Migration Strategies (7 Rs) — AWS Migration Acceleration Program (MAP)
...
- Marketplace, Managed Services, and AWS Partner Network (APN) ecosystem
...
- Technical and business requirements gathering with enterprise and public sector clients.
...
- Continuous support to operational teams providing technical and commercial context.
- MEDDIC methodology practitioner.
...
- Linux environments, MySQL/PostgreSQL databases, VMware virtualization, Microsoft Azure and AWS.
...
- Oracle database, Microsoft Office 365 migration (13,000+ accounts), 200+ Windows Servers, 80+ Linux servers.
- Server modernization projects with Bradesco, Netapp Storage, and Dell Storage.

### Linux Sysadmin
**Ctinet Soluções em Conectividade e Informática** | On-site | Aug 2007 - Mar 2011

- Shell script programming, web server and email server administration (Zimbra, Zarafa, Exchange, Windows Server).
...
**Cloud Native & DevOps:** Kubernetes (Rancher, RKE2, AKS, EKS), Docker, Docker Swarm, Terraform, OpenStack, VMware
...
**Methodologies:** MEDDIC, Pre-Sales Engineering, Solution Architecture, Enterprise Architecture
...
- **Microsoft Certified: Azure AI Engineer Associate** | Issued: Mar 2024 | Expires: Mar 2025
- **Microsoft Certified: Azure Network Engineer Associate** | Issued: Feb 2024 | Expires: Feb 2025
- **AWS Certified Solutions Architect – Professional** | Issued: Dec 2023 | Expires: Dec 2026
- **Microsoft Certified: Azure Security Engineer Associate** | Issued: Sep 2023 | Expires: Sep 2024
...
🖥️ Tela Preta: [telapreta.dev.br](https://www.telapreta.dev.br)
